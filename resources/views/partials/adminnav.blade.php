@include('partials.header')
  <div id="side-menu" class="fixed top-0 right-[-250px] w-[240px] h-screen z-50 bg-gray-700 p-5 flex flex-col space-y-5 text-white duration-300">
  ...
  <main class="h-16 bg-gray-700  flex items-center justify-between">
